...
(custom-set-variables
 ...
 '(package-selected-packages
   '(dockerfile-mode flycheck-rust flycheck dap-mode lsp-treemacs lsp-ui lsp-mode markdown-mode modern-cpp-font-lock ranger dashboard winum highlight-indent-guides evil-surround auto-highlight-symbol rg hungry-delete tabbar consult-projectile tree-sitter treemacs magit hydra projectile general doom-themes helpful vscode-dark-plus-theme which-key rainbow-delimiters doom-modeline command-log-mode use-package consult embark marginalia orderless vertico keycast company)))
(custom-set-faces
